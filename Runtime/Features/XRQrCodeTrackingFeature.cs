// <copyright file="XRQrCodeTrackingFeature.cs" company="Google LLC">
//
...
namespace Google.XR.Extensions
{
    ...
    /// <c>XR_ANDROID_trackables</c> and <c>XR_ANDROID_trackables_qr_code</c> at runtime and
    ...
    [OpenXRFeature(UiName = UiName,
        ...
        Desc = "Enable Android XR QR Code Tracking at runtime. " +
    ...
    public class XRQrCodeTrackingFeature : OpenXRFeature
    {
        ...
        /// </summary>
        public const string UiName = "Android XR (Extensions): Image Tracking (QR Code)";

        /// <summary>
        /// The feature ID string.
        /// </summary>
        public const string FeatureId = "com.google.xr.extensions.qrcode_tracking";
        ...
        [Tooltip(
            ...
            "you may still need to specify the physical size in QR Code reference.")]
        [SerializeField]
        ...
        protected override void OnSubsystemCreate()
        {
            ...
            if (_subsystemInstance == null)
            {
                Debug.LogErrorFormat(
                    "Failed to find descriptor '{0}' - QR Code Tracking will not do anything!",
        ...
        private void OnValidate()
        {
            ...
            foreach (GameObject rootGameObject in rootGameObjects)
            {
                ...
                {
                    AndroidXRRuntimeImageLibrary.ValidateQrCode(imageManager.referenceLibrary);
                    return;
                }
            }
        }
